package task.entities.building;

import task.entities.floor.Floor;
import task.entities.lift.Lift;
import task.entities.person.Person;
import lombok.Getter;
import lombok.Setter;
import task.service.FloorService;
import task.service.LiftService;
...
import static task.entities.building.BuildingConstant.MAX_LIFT;
import static task.entities.lift.LiftConstant.MAX_WEIGHT;
